...
class shanghutong(unittest.TestCase):
    """财务信息"""
    def setUp(self):
        self.base_url = 'http://121.43.60.118:8082/stats/stats/finance'
        payload = {'token': token, 'userId': userid, 'statsid': '26361',
                   'amount': '100', 'reason': 'refund', 'explain': 'test'
                   }
        self.params = payload
