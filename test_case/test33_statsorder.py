...
class shanghutong(unittest.TestCase):
    """已结/未结 订单信息统计"""
    def setUp(self):
        self.base_url = 'http://121.43.60.118:8082/stats/stats/order'
        self.payload = {'token': token, 'userId': userid, 'statsId': '26361'}

    def tearDown(self):
        pass

    def test33_statsorder(self):
