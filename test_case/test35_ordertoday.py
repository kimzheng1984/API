...
class shanghutong(unittest.TestCase):
    """当日订单总金额/数量统计"""
    def setUp(self):
        self.base_url = 'http://121.43.60.118:8082/stats/stats/order/today'
        self.payload = {'userId': userid, 'mchId': '2485'}

    def tearDown(self):
        pass

    def test35_ordertoday(self):
